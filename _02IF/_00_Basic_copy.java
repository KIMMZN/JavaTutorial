...
public class _00_Basic_copy {
	...
	public static void main(String[] args) {
		...
		// 점수가(point_ 있다. 만약 점수가 홀수라면 + 10을 하시오.
		int point = 9;
		...
		// stemp2 조건에 따라 참과 거짓을 분리하는 코드 , 문제는 참일경우만
		if(point % 2 == 1) {
			point += 10;
		}		
		...
		// step2 조건에 따라 참과 거짓을 분리하여 코드
		
		
		if(cm1 >= 180) {
			System.out.println("A조");			
		}else if(cm1 >= 170) { // && cm1 < 180 생략가능
		...
		// 시나리오3 - 조건 1에 참인 후에 다시 조건을 순차적으로 판별;
